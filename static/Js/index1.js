...
const aviso = [
  {
    ...
    srcIMG: "../static/img/pngwing.com.png",
  },
  {
    titulo: " Happy Hour",
    descripcion: " De 18hshs a 22hs",
    srcIMG: "../static/img/pngegg (1).png",
  },
  {
...
function inicializarMenu() {
  ...
  for (let x = 0; x < cat.length; x++) {
    ...
    let h4 = crearElemento("h4", cat[x], "", "", "titulo-cat", cat[x]);
    catProd.appendChild(h4);
...
function crearProductoItem(producto) {
  ...
  const h3 = crearElemento("h3", producto.nombre);
  const p = crearElemento("p", producto.descripcion, "", "", "desc");
  ...
  divProd2.appendChild(h3);
  divProd2.appendChild(p);
